...
|Trial0.ipynb| Data exploration prior to first trial| 
...
|Trial7.ipynb| Uses clinical and molecular subclass data (including IHC) to predict Survival Outcome (2 categories) via Logistical Regression and XGBoost|
